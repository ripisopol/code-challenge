...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="bg-pink-500 mt-auto">
      <div className="container mx-auto px-4 py-10 md:flex md:justify-between md:items-center relative">
        ...
        <button
          ...
          className="absolute top-8 right-2  md:relative md:hidden inline-flex items-center p-2 w-12 h-12 justify-center text-sm text-white rounded-lg hover:bg-pink-400 focus:outline-none focus:ring-2 focus:ring-pink-500"
        ...
        <div className={`md:flex md:w-auto ${isMobileMenuOpen ? 'block' : 'hidden'}`} id="navbar-default">
          <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-white md:border-0 rounded-lg md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:bg-pink-500 ">
            <li>
              <Link
                href="/about"
